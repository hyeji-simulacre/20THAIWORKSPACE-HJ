...
Usage:
python yt_sub_extract_yt-transcript-api.py "URL"
"""
import sys
import json
import re
...
def save_to_json(data: Tuple[Any, Dict[str, Any]]):
    ...
    output_dir = repo_root / "50_resources" / "57_youtube_CA"
...
def main():
    if len(sys.argv) < 2:
        print("Usage: python yt_sub_extract_yt-transcript-api.py \"URL\"")
        sys.exit(1)
