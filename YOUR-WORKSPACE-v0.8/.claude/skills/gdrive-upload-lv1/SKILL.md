...
```powershell
python .claude/skills/_education_skills/share_gdrive_lv1_eduv/scripts/gdrive_upload.py
```
...
```powershell
# 폴더 ID/URL로 지정
python .claude/skills/_education_skills/share_gdrive_lv1_eduv/scripts/gdrive_upload.py --targetfolder "URL_OR_ID"
```
...
```powershell
python .claude/skills/_education_skills/share_gdrive_lv1_eduv/scripts/gdrive_upload.py --dry-run
```
...
```powershell
python .claude/skills/_education_skills/share_gdrive_lv1_eduv/scripts/gdrive_upload.py --file "D:\MyFile.pdf"
```
...
```powershell
python -m pip install -r .claude/skills/_education_skills/share_gdrive_lv1_eduv/requirements.txt
```
...
python .claude/skills/_education_skills/share_gdrive_lv1_eduv/scripts/gdrive_auth.py
```
