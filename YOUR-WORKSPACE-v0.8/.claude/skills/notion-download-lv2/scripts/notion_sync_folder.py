...
DEFAULT_SYNC_ROOT_REL = (
    Path("10_projects")
    / "13_지피터스_지식관리자동화워크스페이스"
    / "__외부연동_노션_구글"
)
...
def main() -> int:
    ...
    print("NOTE: notion_sync_folder.py는 legacy(구버전) 스크립트입니다. 신규 운영은 notion_upload_outbox.py / notion_download_tree.py 사용을 권장합니다.")
    ...
    try:
        ...
        print("Install: python -m pip install -r .claude/skills/_education_skills/share_notion_lv2_eduv/requirements.txt")
        return 2
