...
> **참고**: 31-web-scraps, 32-youtube는 스킬(Skills)로 자동 저장됩니다.
...
| `notion-down-lv2` | Notion 다운로드 | `10-working/{프로젝트}/notion/` |
| `gdrive-up-lv1` | Google Drive 업로드 | - |
| `gdrive-down-lv2` | Google Drive 다운로드 | `10-working/{프로젝트}/gdrive/` |
...
| 레벨 표시 (필요시) | `notion-up-lv1`, `gdrive-down-lv2` |
