...
# (선택) 강제 모드
python .claude/skills/web-scraper/scripts/explore_template.py https://example.com --mode static
python .claude/skills/web-scraper/scripts/explore_template.py https://example.com --mode rss
python .claude/skills/web-scraper/scripts/explore_template.py https://example.com --mode playwright

# 2단계: 스크립트 생성 (출력 형식 선택)
python .claude/skills/web-scraper/scripts/create_scrapping.py ./structure.json -f json
...
python .claude/skills/web-scraper/scripts/create_scrapping.py ./structure.json -f all  # 전체
...
```powershell
python .claude/skills/web-scraper/scripts/create_scrapping.py ./structure.json -f csv --data-output-dir "temp\\test\\crawling"
```
...
수집한 데이터를 정리된 노트로 만들 때는 `00-system/01-templates/31-web-scraps-template.md`를 참조하세요.
