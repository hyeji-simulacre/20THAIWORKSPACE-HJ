...
python -m pip install -r .claude/skills/youtube-subtitle/requirements.txt
```
...
**실행:**
```powershell
python ".claude/skills/youtube-subtitle/scripts/yt_sub_extract_yt-transcript-api_eduv.py" "https://www.youtube.com/watch?v=VIDEO_ID"
```
