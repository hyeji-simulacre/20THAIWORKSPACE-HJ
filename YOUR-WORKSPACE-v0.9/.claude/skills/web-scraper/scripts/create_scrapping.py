...
DEFAULT_DATA_OUTPUT_DIR = "temp/91_temp_create_files"
...
def create_scraping_script(
    ...
    if not output_script_path:
        if analysis_method == "rss":
            output_script_path = f"temp/91_temp_create_files/scrape_{domain}_feed.py"
        elif analysis_method == "static_html":
            output_script_path = f"temp/91_temp_create_files/scrape_{domain}_static.py"
        else:
            output_script_path = f"temp/91_temp_create_files/scrape_{domain}.py"
