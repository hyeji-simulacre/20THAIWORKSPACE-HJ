...
```
/news-briefing [이메일 내용 또는 뉴스 텍스트]
```

### 예시

```
/news-briefing [Google Alerts 이메일 내용 붙여넣기]
/news-briefing [뉴스레터 내용 붙여넣기]
```
...
3. 빈도: "하루에 한 번" 선택
4. 받은 이메일 내용을 `/news-briefing`에 붙여넣기
...
2. /news-briefing [이메일 내용]
3. /daily-note → 뉴스 브리핑 링크 추가
```
