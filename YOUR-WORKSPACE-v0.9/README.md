...
| `/22-reading-note [책 제목]` | 독서/PDF/논문 노트 생성 | `20-created/22-reading-notes/` |
...
**기능:**
- 데드라인 기반 역순 일정 계산
- Johnny Decimal 번호 체계 자동 할당
- `/51-daily-note` 실행 시 오늘 할 프로젝트 태스크 자동 연동
